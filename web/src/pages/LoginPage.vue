...
<template>
  <div class="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#e3f2fd] to-[#e0f2f1] p-6">
    <div class="card w-full max-w-sm p-8 text-center shadow-sm">
      <AppLogo :size="64" class="mx-auto mb-3" />
      <h1 class="text-2xl font-semibold text-slate-800">Ventrafin</h1>
      <p class="mt-1 mb-6 text-slate-600">Home finances, on the PC and the phone.</p>
      <Button
        class="w-full"
        :loading="busy"
      ...
      >
        <template #icon>
          <svg viewBox="0 0 48 48" width="22" height="22" aria-hidden="true" class="mr-1 rounded-full bg-white p-[2px]">
