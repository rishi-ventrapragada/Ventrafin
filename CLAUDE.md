...
- **Secrets stay out of the repo.** The MCP server authenticates via OAuth; `.mcp.json` holds only the project ref. Never write the service_role key, the database password, or OAuth client secrets into any file.
